    ...
    def get(self, request, product_id):
        ...
        try:
            ...
            data = {
                ...
                'name': product.name,
                'slug': product.slug,
                'price': str(product.current_price) if product.is_price_visible else None,
                'base_price': str(product.base_price) if product.is_price_visible else None,
                'has_discount': product.has_discount if product.is_price_visible else False,
                'discount_percentage': product.discount_percentage if product.is_price_visible else 0,
                'show_price': product.is_price_visible,
