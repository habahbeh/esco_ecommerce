    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_keywords', models.CharField(blank=True, help_text='كلمات مفتاحية مفصولة بفواصل', max_length=200, validators=[django.core.validators.MinLengthValidator(5)], verbose_name='كلمات مفتاحية SEO')),
                ('name', models.CharField(max_length=100, verbose_name='اسم العلامة التجارية')),
                ('name_en', models.CharField(blank=True, max_length=100, verbose_name='Brand Name')),
                ('slug', models.SlugField(allow_unicode=True, max_length=100, unique=True, verbose_name='معرف URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_description', models.TextField(blank=True, help_text='وصف الصفحة لمحركات البحث', max_length=160, validators=[django.core.validators.MinLengthValidator(20)], verbose_name='وصف SEO')),
                ('meta_keywords', models.CharField(blank=True, help_text='كلمات مفتاحية مفصولة بفواصل', max_length=200, validators=[django.core.validators.MinLengthValidator(5)], verbose_name='كلمات مفتاحية SEO')),
                ('name', models.CharField(help_text='اسم الفئة - على الأقل حرفين', max_length=50, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='اسم الفئة')),
                ('name_en', models.CharField(blank=True, help_text='English category name (optional)', max_length=100, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Category Name (English)')),
                ('slug', models.SlugField(allow_unicode=True, help_text='معرف فريد للرابط', max_length=100, unique=True, verbose_name='معرف URL')),
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='products.category', verbose_name='الفئة الأب')),
            ],
            options={
                'verbose_name': 'فئة',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_description', models.TextField(blank=True, help_text='وصف الصفحة لمحركات البحث', max_length=160, validators=[django.core.validators.MinLengthValidator(20)], verbose_name='وصف SEO')),
                ('meta_keywords', models.CharField(blank=True, help_text='كلمات مفتاحية مفصولة بفواصل', max_length=200, validators=[django.core.validators.MinLengthValidator(5)], verbose_name='كلمات مفتاحية SEO')),
                ('name', models.CharField(help_text='يجب أن يكون اسم المنتج على الأقل حرفين', max_length=150, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='اسم المنتج')),
                ('name_en', models.CharField(blank=True, help_text='English product name (optional)', max_length=150, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Product Name')),
                ('slug', models.SlugField(allow_unicode=True, max_length=191, unique=True, verbose_name='معرف URL')),
                ...
                ('short_description', models.TextField(blank=True, help_text='وصف مختصر للمنتج - على الأقل 10 أحرف', max_length=200, validators=[django.core.validators.MinLengthValidator(10)], verbose_name='وصف مختصر')),
                ...
                ('base_price', models.DecimalField(decimal_places=4, default=0, max_digits=10, verbose_name='السعر الأساسي')),
                ('compare_price', models.DecimalField(blank=True, decimal_places=4, max_digits=10, null=True, verbose_name='سعر المقارنة')),
                ('cost', models.DecimalField(blank=True, decimal_places=4, max_digits=10, null=True, verbose_name='تكلفة المنتج')),
                ...
                ('tax_rate', models.DecimalField(blank=True, decimal_places=2, default=16, help_text='نسبة الضريبة المضافة', max_digits=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='نسبة الضريبة')),
                ...
                ('stock_status', models.CharField(choices=[('in_stock', 'متوفر'), ('out_of_stock', 'غير متوفر')], default='in_stock', max_length=20, verbose_name='حالة المخزون')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_agent', models.CharField(blank=True, max_length=200, verbose_name='معرف المتصفح')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاريخ الإنشاء')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='تاريخ التحديث')),
                ('name', models.CharField(help_text='مثل: أحمر، كبير، 64 جيجا', max_length=100, verbose_name='اسم المتغير')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['slug'], name='products_ta_slug_d1be68_idx'), models.Index(fields=['usage_count'], name='products_ta_usage_c_3f6e62_idx')],
            },
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.AddIndex(
            model_name='reviewimage',
            index=models.Index(fields=['sort_order'], name='products_re_sort_or_16ef1a_idx'),
        ),
        migrations.AddIndex(
            model_name='product',
